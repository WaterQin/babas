...
<div id="top">
    <div class="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="215">
                    <div class="logo"><img src="/res/itcast/img/admin/logo.jpg" width="215" height="69"/></div>
                </td>
                <td valign="top">
                    <div class="topbg">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="420" height="38">
                                        ...
                                        <img src="/res/itcast/img/admin/loginout-icon.png"/><a
                                            href="logout.do?returnUrl=index.do" target="_top" id="logout"
                                            onclick="return confirm('您确定退出吗?');">退出</a> 
                                        <img src="/res/itcast/img/admin/message-unread.png"/>&nbsp;<a
                        ...
                        <div class="nav">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="background-image:url('/res/itcast/img/admin/nav-left.png')" width="14"
                                        height="31"></td>
                                    <td>
                                        <ul class="nav-menu">
