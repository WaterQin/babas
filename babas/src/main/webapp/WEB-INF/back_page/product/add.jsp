            ...
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    <c:forEach var="features" items="${features}">
                        <input type="checkbox" value="${features.id}" name="feature"/>${features.name}
                    </c:forEach>
                </td>
            </tr>
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    <c:forEach var="colors" items="${colors}">
                        <input type="checkbox" name="color" value="${colors.id}"/>${colors.name}
                    </c:forEach>
                </td>
            </tr>
            <tr>
