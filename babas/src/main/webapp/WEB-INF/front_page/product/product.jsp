...
<head>
    ...
    <script type="text/javascript">
        //登陆
        function login() {
            window.location.href = "/shopping/login.shtml";
        }
    </script>
</head>
<body>
        ...
        <div class="box bg_white">
            <ul class="uls i_150x150 x4_150x150">
                <li>
                    ...
                    <dl>
                        <dt><a href="/product/detail.shtml?id=${entry.id}" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a>
                        </dt>
            ...
            <li><b>品牌：</b>
                <p>
                    ...
                    <c:forEach items="${brands}" var="brands">
                        <a href="/product/list/display.shtml?brandId=${brands.id}&brandName=${brands.name}&typeName=${typeName }&typeId=${typeId}"
                           title="${brands.name}">${brands.name}</a>
                    </c:forEach>
                </p></li>
            <li><b>价格：</b>
                <p>
            ...
            <li><b>类型：</b>
                <p>
                    ...
                    <c:forEach items="${types}" var="type">
                        <a href="/product/list/display.shtml?typeId=${type.id}&brandId=${brandId }&brandName=${brandName}&typeName=${type.name}"
            ...
            <li><b>材质：</b>
                <p>
                    ...
                    <c:forEach items="${features}" var="features">
                        <a href="#" title="${features.name}">${features.name}</a>
                    </c:forEach>
                </p></li>
        ...
        <div class="mt ofc">
            <ul class="uls i_150x150 x4_150x150b">
                <c:forEach items="${pagination.list}" var="product">
                    <li>
                        <a href="/product/display/detail.shtml?id=${product.id}" title="${type.name}" target="_blank"
                           class="pic"><img src="${product.img.url}" alt="瑜伽服"/></a>
                        <dl>
                            <!-- dt 10个文字+... -->
                            <dt><a href="/product/display/detail.shtml?id=${product.id}" title="${product.name}"
                                   target="_blank">${product.name}</a></dt>
                            <!-- dt 25个文字+... -->
            ...
            <div class="page pb15">
				<span class="r inb_a page_b">
					<span id="previousNo" class="inb" title="上一页"><samp>&lt;&lt;</samp>上一页</span><a
                        href="javascript:void(0);" id="previous" title="上一页" style="display:none"><samp>&lt;&lt;</samp>上一页</a><span
                        title="第1页" class="inb current">1</span><!--a href="#" title="第1页">1</a--><a
                        href="/product/display/list.shtml?pageNo=2" title="第2页">2</a><a
                        href="/product/display/list.shtml?pageNo=3" title="第3页">3</a><a
                        href="/product/display/list.shtml?pageNo=4" title="第4页">4</a><a
                        href="/product/display/list.shtml?pageNo=5" title="第5页">5</a><span class="break">...</span><a
                        href="#" title="第16页">16</a><span id="nextNo" class="inb" title="下一页"
                                                          style="display:none">下一页<samp>&gt;&gt;</samp></span><a
                        href="javascript:void(0);" id="next" title="下一页">下一页<samp>&gt;&gt;</samp></a>共<var
                        id="pageTotal" class="orange">0</var>页 到第<input type="text" id="number" name="number"
                                                                        class="txts" size="3"/>页 <input type="button"
                                                                                                        id="skip"
                                                                                                        class="hand btn60x20"
                                                                                                        value='确定'/>
				</span>
