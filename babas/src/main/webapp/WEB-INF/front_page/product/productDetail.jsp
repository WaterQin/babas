...
<div class="w ofc mt">
    <div class="l">
        <div class="showPro">
            <div class="big"><a id="showImg" class="cloud-zoom" href="${img[0].url}" rel="adjustX:10,adjustY:-1"><img
                    alt="" src="${img[0].url}"></a></div>
        </div>
    </div>
    <div class="r" style="width: 640px">
        <ul class="uls form">
            <li><h2>${product.name }</h2></li>
            <li><label>巴 巴 价：</label><span class="word"><b class="f14 red mr">￥128.00</b>(市场价:<del>￥150.00</del>)</span>
            </li>
            ...
            <li><label>库　　存：</label><span class="word" id="stockInventory">${fn:length(skus)} </span><span class="word">件</span>
            </li>
            <li><label>选择颜色：</label>
                <div id="colors" class="pre spec">
                    <c:forEach items="${colors}" var="colors">
                        <a onclick="colorToRed(this,${colors.id})" href="javascript:void(0)" title="${colors.name}"
                           class="changToRed"><img width="25" height="25" data-img="1" src="${img[0].url}"
                                                   alt="${colors.name} "><i>${colors.name}</i></a>
                    </c:forEach>
                </div>
            </li>
