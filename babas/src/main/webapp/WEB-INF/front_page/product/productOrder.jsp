...
<form action="/buyer/confirmOrder.shtml" method="post">
    ...
    <div class="w ofc case">
        <h2 class="h2 h2_r mt"><em title="收货人信息">收货人信息 [<a href="#"><font
                style="color:blue;">修改</font></a>]</em><cite></cite></h2>
                ...
                <c:forEach items="${buyCart.items }" var="item">
                    <tr>
                        ...
                        <td class="img48x20">
                            ...
                            <a href="/product/detail.shtml?id=${item.sku.product.id }"
                               target="block">${fn:substring(item.sku.product.name,0,30)}--${item.sku.color.name}--${item.sku.size}</a>
                        </td>
            ...
            <div class="ofc">
                <div class="r">
                    <dl class="total">
                        ...
                        <dd class="orange"><em class="l">应付总额：</em>￥<var id="totalMoney">${buyCart.totalPrice }</var>
                        </dd>
                        <dd class="alg_c"><input id="submitOrderID" type="submit" href="#" value="提交订单"
                                                 class="hand btn136x36a"/></dd>
                    </dl>
                </div>
            </div>
        </div>
