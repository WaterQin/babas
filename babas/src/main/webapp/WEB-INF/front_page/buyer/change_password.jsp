                ...
                <form id="jvForm" action="profile.do" method="post">
                    ...
                    <ul class="uls form">
                        ...
                        <li>
                            ...
                            <span class="bg_text"><input type="password" id="password" name="password" maxLength="32"
                        ...
                        <li>
                            ...
                            <span class="bg_text"><input type="text" id="realPassword" name="realPassword"
                                                         maxLength="32" vld="{required:true}"/></span>
                            <span class="pos"><span class="tip okTip">&nbsp;</span></span>
                        </li>
                        <li>
                            <label for="confirmPassword">确认新密码：</label>
                            <span class="bg_text"><input type="text" id="confirmPassword" name="confirmPassword"
                                                         maxLength="32" vld="{required:true}"/></span>
