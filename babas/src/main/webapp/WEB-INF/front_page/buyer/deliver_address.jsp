...
<head>
    ...
    <script type="text/javascript">
        ...
        function addAddr() {
            ...
            var url = "/buyer/deliverAddr.shtml";
            var params = {
                "id": id,
                "name": name,
...
<div class="bar">
    <div class="bar_w">
        ...
        <ul class="r uls">
            ...
            <li class="dev"><a href="/shopping/logout.shtml" title="退出">[退出]</a></li>
                ...
                <table cellspacing="0" summary="" class="tab tab6">
                    ...
                    <c:forEach items="${addrs}" var="addr">
                        <tr <c:if test="${addr.isDef == 1 }">class="here"</c:if>>
                            <input class="hidden" value="${addr.id}" id="id" name="id"/>
                            <td>${addr.name}</td>
                            <td>${addr.city}</td>
                            <td>${addr.addr}</td>
                            <td>${addr.phone}</td>
                ...
                <form id="jvForm" method="post">
                    <ul class="uls form">
                        ...
                        <li>
                            ...
                            <span><input type="checkbox" id="isDef" name="isDef"/>设为默认收货地址</span>
                        </li>
                        <li><label for="">&nbsp;</label><input type="submit" onclick="addAddr()" value="保存"
